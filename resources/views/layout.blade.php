...
<body class="font-bold antialiased capitalize" style="font-family:Quicksand">
...
<section class="px-6 py-4 ">
    <nav class="flex justify-between items-center text-dark">
        ...
        <div class="text-dark">
            <a href="/" class="bg-blue-500 p-2 ml-2 rounded-full text-xs font-semibold uppercase">posts</a>
            <a href="/about" class="text-xs p-2 ml-1">about</a>
            <a href="/contact" class="text-xs p-2 ml-1">contact</a>
        </div>
    </nav>
</section>
    ...
    <header class="max-4xl mx-auto mt-10 text-center bg-blue-500 text-black">
        <div class="max-w-lg mx-auto">
            <div class="max-w-md mx-auto">
                <h1 class="text-3xl">latest <span class="text-black-500">trends 254 </span></h1>
                ...
                <p class="mt-2">Joining takes less than a minute, and, if your peers are correct, is the best decision you'll make all day. If you're still on the fence, we have a plan called “monthly” - and it’s not like the gym. Seriously, you can cancel in five seconds.</p>
            </div>
...
<footer class="pt-4">
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div class="max-w-xl lg:max-w-lg">
                ...
                <p class="mt-4 text-lg leading-8 text-gray-300">get newsletters direct to your mail! we got you .</p>
            ...
            <dl class="grid grid-cols-1 gap-x-8 gap-y-10 sm:grid-cols-2 lg:pt-2">
                ...
                <dd class="mt-2 leading-7 text-gray-400">weekly updates strsight to your email</dd>
                </div>
                <div class="flex flex-col items-start">
                <div class="rounded-md bg-white/5 p-2 ring-1 ring-white/10">
                    <svg class="h-6 w-6 text-white" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                ...
                <dd class="mt-2 leading-7 text-gray-400">weekly updates strsight to your email, no spam</dd>
                </div>
            </dl>
            </div>
        </div>
